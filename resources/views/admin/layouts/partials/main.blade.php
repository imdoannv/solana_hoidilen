                                    ...
                                    <div class="flex">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                 src="{{asset('be/dist/images/preview-12.jpg')}}"
                            ...
                            <tr class="intro-x">
                                <td class="w-40">
                                    <div class="flex">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                 src="{{asset('be/dist/images/preview-15.jpg')}}"
                                                 title="Uploaded at 18 October 2022">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                 src="{{asset('be/dist/images/preview-5.jpg')}}"
                            ...
                            <tr class="intro-x">
                                <td class="w-40">
                                    <div class="flex">
                                        ...
                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                 src="{{asset('be/dist/images/preview-14.jpg')}}"
                                                 title="Uploaded at 23 August 2021">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                 src="{{asset('be/dist/images/preview-9.jpg')}}"
